...
moduleForModel('data-line-proto-one-dictionary-value', 'Unit | Serializer | data-line-proto-one-dictionary-value', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-proto-one-dictionary-value',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
