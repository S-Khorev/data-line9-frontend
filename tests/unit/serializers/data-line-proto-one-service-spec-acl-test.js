...
moduleForModel('data-line-proto-one-service-spec-acl', 'Unit | Serializer | data-line-proto-one-service-spec-acl', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-proto-one-service-spec-acl',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
