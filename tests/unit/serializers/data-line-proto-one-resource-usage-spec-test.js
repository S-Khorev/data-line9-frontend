...
moduleForModel('data-line-proto-one-resource-usage-spec', 'Unit | Serializer | data-line-proto-one-resource-usage-spec', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-proto-one-resource-usage-spec',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
