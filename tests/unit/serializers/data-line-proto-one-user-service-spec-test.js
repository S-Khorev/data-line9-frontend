...
moduleForModel('data-line-proto-one-user-service-spec', 'Unit | Serializer | data-line-proto-one-user-service-spec', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-proto-one-user-service-spec',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
