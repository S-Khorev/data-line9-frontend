...
moduleForModel('data-line-proto-one-cardinality-type', 'Unit | Serializer | data-line-proto-one-cardinality-type', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-proto-one-cardinality-type',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
