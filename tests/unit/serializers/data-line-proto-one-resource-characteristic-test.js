...
moduleForModel('data-line-proto-one-resource-characteristic', 'Unit | Serializer | data-line-proto-one-resource-characteristic', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-proto-one-resource-characteristic',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
