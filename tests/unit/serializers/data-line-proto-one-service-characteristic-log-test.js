...
moduleForModel('data-line-proto-one-service-characteristic-log', 'Unit | Serializer | data-line-proto-one-service-characteristic-log', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-proto-one-service-characteristic-log',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
