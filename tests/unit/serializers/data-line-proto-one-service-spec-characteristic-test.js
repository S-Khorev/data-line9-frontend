...
moduleForModel('data-line-proto-one-service-spec-characteristic', 'Unit | Serializer | data-line-proto-one-service-spec-characteristic', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-proto-one-service-spec-characteristic',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
