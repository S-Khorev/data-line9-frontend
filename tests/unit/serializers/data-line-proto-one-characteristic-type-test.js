...
moduleForModel('data-line-proto-one-characteristic-type', 'Unit | Serializer | data-line-proto-one-characteristic-type', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-proto-one-characteristic-type',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
