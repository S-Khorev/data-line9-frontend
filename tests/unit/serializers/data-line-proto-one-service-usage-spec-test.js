...
moduleForModel('data-line-proto-one-service-usage-spec', 'Unit | Serializer | data-line-proto-one-service-usage-spec', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-proto-one-service-usage-spec',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
